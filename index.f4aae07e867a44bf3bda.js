...
;// CONCATENATED MODULE: ./src/js/animate.js
...
var animate = function animate() {
  ...
  tl.to(".preloader", {
    ...
    y: 0,
    duration: 0.5
  }, "-=0.8").fromTo(".button__prev, .button__next, .slide-numbers", {
    opacity: 0
  }, {
    opacity: 1,
    duration: 0.4,
  ...
  var tl1 = gsapWithCSS.to(".title-light", {
    x: -200
  });
  var tl2 = gsapWithCSS.to(".title-bold", {
    x: 200
  });
  var tlSlader = gsapWithCSS.to(".slider-item", {
    backgroundSize: "110%",
  ...
  var trigger = gsapWithCSS.utils.toArray(".animate");
  trigger.forEach(function (element) {
    var q = gsapWithCSS.utils.selector(element);
    var tl3 = gsapWithCSS.timeline();
    var tl4 = gsapWithCSS.timeline();
    if (q(".gallery_items").length > 0) {
      tl3.fromTo(q(".gallery_items"), {
        height: "0%",
        opacity: 1
      }, {
        height: "100%",
...
;// CONCATENATED MODULE: ./node_modules/swiper/shared/get-element-params.mjs
...
function getParams(element, propName, propValue) {
  ...
  update_swiper_extend(params, passedParams);
...
;// CONCATENATED MODULE: ./node_modules/swiper/swiper-element-bundle.mjs
/**
